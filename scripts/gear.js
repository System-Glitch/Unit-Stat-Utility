var gear = {
	...
	axe: [
		{name: "None", img: 'Slot/GreatAxeSlot_ua.png'},
		{
			...
			effects: {
				15: [{min: 10, max: 12, positive: true, type: "damage"}]
			}
		},
		{
			name: "Sample axe 2",
			...
			effects: {
				27: [{min: 40, max: 53.9, positive: true, type: "damage"}]
			}
		}
	],
	cavalryArmor: [
		...
		},
		{
			...
			effects: {
				40: [{min: -40.0, max: 0.0, positive: false, type: "health"}]
			}
		}
	],
	infantryArmor: [
		{name: "None", img: 'Slot/MedArmorSlot_ua.png'},
		{
			...
			effects: {
				37: [{min: 10, max: 30, positive: true, type: "health"}],
			}
		},
		{
			...
			effects: {
				40: [{min: 70, max: 80, positive: true, type: "health"}],
			}
		},
		{
			...
			effects: {
				40: [{min: 72, max: 85, positive: true, type: "health"}],
			}
		}
	],
	soldierGear: [
		...
		},
		{
			...
			effects: {
				37: [
						{min: 18, max: 20, positive: false, type: "cost"},
						{min: 7, max: 9, positive: true, type: "damage"},
						{min: 17, max: 21, positive: true, type: "health"}
					],
				40: [
